...
> **Историческая матрица от 2026-09-24.** Актуальные 42 lab аккаунта, 39 находок, Security Score 75, применённая FGPP и постоянный сбор интерактивных прав описаны в [TZ_AUDIT_CURRENT.md](TZ_AUDIT_CURRENT.md). Статусы и числа ниже отражают прежние проверки; положительные UNIT случаи не считаются LIVE.

> Ниже сохранены доказательства проверок на момент исходного аудита. Для текущего состояния используйте [актуальный аудит](TZ_AUDIT_CURRENT.md).
...
Эта таблица сохраняет исторические доказательства. Обязательный MVP был проверен, но положительные случаи старого входа/пароля, SIDHistory, duplicate SPN и delegation не подделывались ради live результата. Текущий scan, состав OU и ограничения — в [TZ_AUDIT_CURRENT.md](TZ_AUDIT_CURRENT.md).
