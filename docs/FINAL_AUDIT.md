...
> **Исторический отчёт от 2026-09-24.** Актуальные 42 аккаунта, 39 находок, Security Score 75, применённая FGPP и постоянный сбор интерактивных прав описаны в [TZ_AUDIT_CURRENT.md](TZ_AUDIT_CURRENT.md). Числа ниже отражают старые scan.

> Ниже сохранены доказательства прежних live-проверок. Для текущего состояния используйте [актуальный аудит](TZ_AUDIT_CURRENT.md).
...
После того исторического scan в lab OU появился дополнительный disabled `adm.t.zhaksybek` с отдельным Critical-сценарием. Дальнейшие изменения и актуальные числа зафиксированы в [TZ_AUDIT_CURRENT.md](TZ_AUDIT_CURRENT.md).
