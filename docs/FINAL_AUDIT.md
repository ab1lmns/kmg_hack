...
> **Обновление 2026-09-24:** этот отчёт фиксирует предыдущие live-проверки. Текущая доступность и сверка с ТЗ находятся в [TZ_AUDIT_CURRENT.md](TZ_AUDIT_CURRENT.md). VM DC сейчас `Saved`; по просьбе владельца она не запускается.
