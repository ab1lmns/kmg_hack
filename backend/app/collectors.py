...
def collect_ldap(settings: Settings, classify: bool = True) -> Snapshot:
        ...
        with Connection(
            ...
            users = list(connection.extend.standard.paged_search(
                ...
                attributes=[
                    ...
                    "userPrincipalName", "displayName", "givenName", "sn", "title", "company",
                    "whenCreated", "primaryGroupID", "adminCount",
    ...
    for row in users:
        ...
        accounts.append(Account(
            ...
            given_name=str(attrs.get("givenName") or ""),
            surname=str(attrs.get("sn") or ""),
